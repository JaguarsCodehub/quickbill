                ...
                <ScrollView nestedScrollEnabled={true} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.card}>
                        <View style={styles.sectionHeader}>
                            <Text style={styles.sectionTitle}>Purchase Invoice Items</Text>
                            {orderItems.length > 0 && (
                        ...
                        {orderItems.length > 0 ? (
                            ...
                            <Text style={styles.noItemsText}>No items added to Purchase Invoice yet.</Text>
                        )}
                    </View>
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <Text style={styles.submitButtonText}>Submit Purchase Invoice</Text>
                        )}
                    </TouchableOpacity>
                </ScrollView>
            </LinearGradient>
                    ...
                    <View style={[styles.itemModalContent, { width: '90%', maxHeight: '80%' }]}>
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <TouchableOpacity onPress={handleAddItemToOrder} style={styles.addButton}>
                                <Text style={styles.addButtonText}>Add to Purchase Invoice</Text>
                            </TouchableOpacity>
                        </ScrollView>
                    </View>
                </View>
