...
const CreatePurchaseReturn = () => {
    ...
    const fetchItems = async () => {
        try {
            ...
            const response = await axios.get('https://quickbill-backlend.vercel.app/purchase-return-items', {
                headers: {
                    'UserID': userId,
                    'CompanyID': companyId,
                    'Prefix': prefix,
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch('https://quickbill-backlend.vercel.app/api/create-purchase-return', {
                method: 'POST',
                headers: {
                ...
                <ScrollView nestedScrollEnabled={true} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.card}>
                        <View style={styles.sectionHeader}>
                            <Text style={styles.sectionTitle}>Purchase Return Items</Text>
                            {orderItems.length > 0 && (
                        ...
                        {orderItems.length > 0 ? (
                            ...
                            <Text style={styles.noItemsText}>No items added to purchase return yet.</Text>
                        )}
                    </View>
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <Text style={styles.submitButtonText}>Submit Purchase Return</Text>
                        )}
                    </TouchableOpacity>
                    ...
                    <View style={[styles.itemModalContent, { width: '90%', maxHeight: '80%' }]}>
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <TouchableOpacity onPress={handleAddItemToOrder} style={styles.addButton}>
                                <Text style={styles.addButtonText}>Add to Purchase Return</Text>
                            </TouchableOpacity>
                        </ScrollView>
                    </View>
                </View>
